"""
Django settings for ncbcgs_9 project.
...
WSGI_APPLICATION = 'ncbcgs_9.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ncbcgs_9 API",
    "DESCRIPTION": "API documentation for ncbcgs_9 App",
    "VERSION": "v1",
}
